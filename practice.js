...
var favoriteThings = {band: 'Arrowsmith',
 food: 'Pizza', 
 person: 'Jesus', 
 book: 'Book of Mormon', 
 movie: 'Bourne', 
...
user.name = 'Bryan Brinton';
user['pwHash'] = jkjslkfjs;
user.username = 'mastercraft';
...
users.push(user2 = {
    ...
    password: 'bry@nr0cks',
    username: 'bryan.brinton'
}
)
users.push(user3 = {
    name: 'Robert Brinton',
    email: 'robert@gmail.com',
    password: 'r0b3rtr0cks',
    username: 'robert.brinton'
}
)
